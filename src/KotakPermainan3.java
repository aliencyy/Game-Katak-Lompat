 /**
 * Class KotakPermainan3 merupakan class yang berisikan jumlah kotak yang akan digunakan dalam permainan,
...
public class KotakPermainan3 {
     ...
     * @param jm
     */
    public KotakPermainan3(int j, int jk, int jm){
        this.jumlahKotak = j;
        this.jumlahKoin = jk;
    ...
    private void inisialisasiKotak(){
        ...
        Koin3 k3 = new Koin3(5);
        Monster3 m3 = new Monster3(-15, "Balmond");
        ...
        for(int i = 0; i < jumlahKoin; i++){
            boardGame[acakKoin[i]].addKoin(k3);
        }

        for(int i = 0; i < jumlahMonster; i++){
            boardGame[acakMonster[i]].addMonster(m3);
        }
    }
